...
public final class PersonaEntidad {
	private UUID id;
	...
	private CiudadEntidad ciudadResidencia;
	...
	public CiudadEntidad getCiudadResidencia() {
	...
	private void setTipoDocumento(final TipoDocumentoEntidad tipoDocumento) {
		this.tipoDocumento = UtilObjeto.obtenerValorDefecto(tipoDocumento, new TipoDocumentoEntidad.Builder().build());
	}
	...
	private void setCiudadResidencia(final CiudadEntidad ciudadResidencia) {
		this.ciudadResidencia = UtilObjeto.obtenerValorDefecto(ciudadResidencia, new CiudadEntidad.Builder().build());
	}
	...
	public static class Builder {
		...
		public Builder ciudadResidencia(final CiudadEntidad ciudadResidencia) {
