...
public final class PropiedadEntidad {
	...
	private void setTipoPropiedad(final TipoPropiedadEntidad tipoPropiedad) {
		this.tipoPropiedad = UtilObjeto.obtenerValorDefecto(tipoPropiedad, new TipoPropiedadEntidad.Builder().build());
	}

	private void setEstrato(final EstratoEntidad estrato) {
		this.estrato = UtilObjeto.obtenerValorDefecto(estrato, new EstratoEntidad.Builder().build());
	}
	...
	private void setCiudad(final CiudadEntidad ciudad) {
		this.ciudad = UtilObjeto.obtenerValorDefecto(ciudad, new CiudadEntidad.Builder().build());
	}
