...
public final class ClausulaContratoEntidad {
	...
	private void setAreaReferencia(final AreaReferenciaEntidad areaReferencia) {
		this.areaReferencia = UtilObjeto.obtenerValorDefecto(areaReferencia,
				new AreaReferenciaEntidad.Builder().build());
	}

	private void setTipoAplicacion(final TipoAplicacionEntidad tipoAplicacion) {
		this.tipoAplicacion = UtilObjeto.obtenerValorDefecto(tipoAplicacion,
				new TipoAplicacionEntidad.Builder().build());
	}
