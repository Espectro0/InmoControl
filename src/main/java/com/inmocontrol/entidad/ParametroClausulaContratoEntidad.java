...
public final class ParametroClausulaContratoEntidad {
	...
	private void setParametro(final ParametroEntidad parametro) {
		this.parametro = UtilObjeto.obtenerValorDefecto(parametro, new ParametroEntidad.Builder().build());
	}

	private void setClausulaPorContrato(final ClausulaPorContratoEntidad clausulaPorContrato) {
		this.clausulaPorContrato = UtilObjeto.obtenerValorDefecto(clausulaPorContrato,
				new ClausulaPorContratoEntidad.Builder().build());
	}
