...
public class ClausulaContratoControlador {
	...
	public ResponseEntity<RespuestaExito<List<ClausulaContratoEntidad>>> consultar(
		...
		if (tieneFiltros) {
			ConsultarClausulaContratoPorFiltrosFachada fachadaFiltros = new ConsultarClausulaContratoPorFiltrosFachadaImpl();
			...
			ConsultarClausulaContratoTodosFachada fachadaTodos = new ConsultarClausulaContratoTodosFachadaImpl();
	...
	public ResponseEntity<RespuestaExito<Void>> registrar(@RequestBody ClausulaContratoDTO dto) {
		...
		return ResponseEntity.status(201).body(RespuestaExito.crear("Clausula de contrato registrada exitosamente"));
	}
	...
	public ResponseEntity<RespuestaExito<Void>> eliminar(@PathVariable UUID id) {
		...
		fachada.ejecutar(dto);
		return ResponseEntity.ok(RespuestaExito.crear("Clausula de contrato eliminada exitosamente"));
	}
}
