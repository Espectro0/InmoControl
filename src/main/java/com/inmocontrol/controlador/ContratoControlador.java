...
public class ContratoControlador {
	...
	public ResponseEntity<RespuestaExito<List<ContratoEntidad>>> consultar(
		...
		boolean tieneFiltros = codigoContrato != null || esActivo != null || propiedadId != null || fechaInicio != null
				|| fechaFin != null;

		if (tieneFiltros) {
			ConsultarContratoPorFiltrosFachada fachadaFiltros = new ConsultarContratoPorFiltrosFachadaImpl();
	...
	public ResponseEntity<RespuestaExito<Void>> registrar(@RequestBody ContratoDTO dto) {
		...
		return ResponseEntity.status(201).body(RespuestaExito.crear("Contrato registrado exitosamente"));
	}
