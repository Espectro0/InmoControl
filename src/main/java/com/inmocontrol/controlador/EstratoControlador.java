...
public class EstratoControlador {
	...
	@GetMapping
	public ResponseEntity<RespuestaExito<List<EstratoEntidad>>> consultar(@RequestParam(required = false) String nombre,
		...
		if (tieneFiltros) {
			ConsultarEstratoPorFiltrosFachada fachadaFiltros = new ConsultarEstratoPorFiltrosFachadaImpl();
