...
public class PersonaControlador {
	...
	public ResponseEntity<RespuestaExito<List<PersonaEntidad>>> consultar(
		...
		boolean tieneFiltros = numeroIdentificacion != null || primerNombre != null || primerApellido != null
				|| correoElectronico != null || tipoDocumentoId != null || ciudadResidenciaId != null;

		if (tieneFiltros) {
			ConsultarPersonaPorFiltrosFachada fachadaFiltros = new ConsultarPersonaPorFiltrosFachadaImpl();
	...
	public ResponseEntity<RespuestaExito<Void>> registrar(@RequestBody PersonaDTO dto) {
		...
		return ResponseEntity.status(201).body(RespuestaExito.crear("Persona registrada exitosamente"));
	}
