...
public class ParametroClausulaContratoPostgresqlDAO extends SQLDAO implements ParametroClausulaContratoDAO {
    ...
    public ParametroClausulaContratoEntidad consultarPorId(UUID id) {
        String sql = "SELECT id, parametro_id, clausula_por_contrato_id, valor "
        ...
        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            ...
            throw new TransaccionExcepcion("Ocurrio un error al consultar el parametro clausula contrato por id.", e);
        }
    ...
    public List<ParametroClausulaContratoEntidad> consultarTodos() {
        String sql = "SELECT id, parametro_id, clausula_por_contrato_id, valor FROM parametro_clausula_contrato";
        ...
        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            ...
            throw new TransaccionExcepcion("Ocurrio un error al consultar los parametros clausula contrato.", e);
        }
    ...
    @Override
    public List<ParametroClausulaContratoEntidad> consultarPorFiltro(ParametroClausulaContratoEntidad filtro) {
        String sql = "SELECT id, parametro_id, clausula_por_contrato_id, valor "
        ...
        if (filtro.getClausulaPorContrato() != null && filtro.getClausulaPorContrato().getId() != null) {
        ...
        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            ...
            throw new TransaccionExcepcion("Ocurrio un error al consultar parametros clausula contrato por filtro.", e);
        }
    ...
    public void crear(ParametroClausulaContratoEntidad entidad) {
        String sql = "INSERT INTO parametro_clausula_contrato (id, parametro_id, clausula_por_contrato_id, valor) "
                + "VALUES (?, ?, ?, ?)";

        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            stmt.setObject(1, entidad.getId());
            stmt.setObject(2, entidad.getParametro() != null ? entidad.getParametro().getId() : null);
            stmt.setObject(3, entidad.getClausulaPorContrato() != null ? entidad.getClausulaPorContrato().getId() : null);
            stmt.setString(4, entidad.getValor());
            stmt.executeUpdate();
        } catch (SQLException e) {
            throw new TransaccionExcepcion("Ocurrio un error al crear el parametro clausula contrato.", e);
        }
    }

    @Override
    public void actualizar(UUID id, ParametroClausulaContratoEntidad entidad) {
        String sql = "UPDATE parametro_clausula_contrato SET parametro_id = ?, clausula_por_contrato_id = ?, "
                + "valor = ? WHERE id = ?";

        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            stmt.setObject(1, entidad.getParametro() != null ? entidad.getParametro().getId() : null);
            stmt.setObject(2, entidad.getClausulaPorContrato() != null ? entidad.getClausulaPorContrato().getId() : null);
            stmt.setString(3, entidad.getValor());
            stmt.setObject(4, id);
            stmt.executeUpdate();
        } catch (SQLException e) {
            throw new TransaccionExcepcion("Ocurrio un error al actualizar el parametro clausula contrato.", e);
        }
    }
    ...
    public void eliminar(UUID id) {
        ...
        try (PreparedStatement stmt = getConexion().prepareStatement(sql)) {
            ...
            throw new TransaccionExcepcion("Ocurrio un error al eliminar el parametro clausula contrato.", e);
        }
    }
    ...
    private ParametroClausulaContratoEntidad mapearResultado(ResultSet rs) throws SQLException {
        return new ParametroClausulaContratoEntidad.Builder()
                ...
                .parametro(new ParametroEntidad.Builder()
                        .id(rs.getObject("parametro_id", UUID.class))
                        .build())
                .clausulaPorContrato(new ClausulaPorContratoEntidad.Builder()
