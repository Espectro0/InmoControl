...
public final class PropiedadDTOAssembler implements DTOAssembler<PropiedadDominio, PropiedadDTO> {
    ...
    public PropiedadDominio ensamblarDominio(final PropiedadDTO dto) {
        var entidadAEnsamblar =
                UtilObjeto.obtenerValorDefecto(dto, new PropiedadDTO.Builder().build());
        return new PropiedadDominio.Builder()
                ...
                .estrato(
                        EstratoDTOAssembler.getInstance()
                                .ensamblarDominio(entidadAEnsamblar.getEstrato()))
                ...
                .ciudad(
                        CiudadDTOAssembler.getInstance()
                                .ensamblarDominio(entidadAEnsamblar.getCiudad()))
                .build();
    }
    ...
    public PropiedadDTO ensamblarDTO(final PropiedadDominio dominio) {
        ...
        return new PropiedadDTO.Builder()
                ...
                .estrato(
                        EstratoDTOAssembler.getInstance()
                                .ensamblarDTO(dominioAEnsamblar.getEstrato()))
                ...
                .ciudad(
                        CiudadDTOAssembler.getInstance()
                                .ensamblarDTO(dominioAEnsamblar.getCiudad()))
                .build();
    }
}
