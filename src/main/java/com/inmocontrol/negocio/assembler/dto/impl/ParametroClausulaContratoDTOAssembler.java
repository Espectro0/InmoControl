...
public final class ParametroClausulaContratoDTOAssembler
    ...
    @Override
    public ParametroClausulaContratoDTO ensamblarDTO(
        ...
        return new ParametroClausulaContratoDTO.Builder()
                ...
                .parametro(
                        ParametroDTOAssembler.getInstance()
                                .ensamblarDTO(dominioAEnsamblar.getParametro()))
                .clausulaPorContrato(
                        ClausulaPorContratoDTOAssembler.getInstance()
