...
public class ConsultarTipoParticipantePorIdCasoUsoImpl implements ConsultarTipoParticipantePorIdCasoUso {
	...
	private TipoParticipanteEntidad consultarTipoParticipante(TipoParticipanteDominio datos) {
		TipoParticipanteEntidad entidad = daoFactory.obtenerTipoParticipanteDAO().consultarPorId(datos.getId());
