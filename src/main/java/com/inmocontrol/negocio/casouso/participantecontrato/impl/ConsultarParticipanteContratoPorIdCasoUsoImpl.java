...
public class ConsultarParticipanteContratoPorIdCasoUsoImpl implements ConsultarParticipanteContratoPorIdCasoUso {
	...
	private ParticipanteContratoEntidad consultarParticipanteContrato(ParticipanteContratoDominio datos) {
		ParticipanteContratoEntidad entidad = daoFactory.obtenerParticipanteContratoDAO().consultarPorId(datos.getId());
