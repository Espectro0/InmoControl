...
public class ConsultarAreaReferenciaPorFiltrosCasoUsoImpl implements ConsultarAreaReferenciaPorFiltrosCasoUso {
    ...
    public List<AreaReferenciaEntidad> ejecutar(AreaReferenciaDominio datos) {
        ...
        return daoFactory.obtenerAreaReferenciaDAO().consultarPorFiltro(
