...
public class ConsultarClausulaPorContratoPorIdCasoUsoImpl
    implements ConsultarClausulaPorContratoPorIdCasoUso {
  ...
  private ClausulaPorContratoEntidad consultarClausulaPorContrato(
      ClausulaPorContratoDominio datos) {
