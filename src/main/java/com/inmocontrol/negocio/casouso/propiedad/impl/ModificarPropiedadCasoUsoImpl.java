...
public class ModificarPropiedadCasoUsoImpl implements ModificarPropiedadCasoUso {
	...
	private void modificarPropiedad(PropiedadDominio datos) {
		PropiedadEntidad entidad = new PropiedadEntidad.Builder().id(datos.getId())
				...
				.ciudad(datos.getCiudad() != null ? new CiudadEntidad.Builder().id(datos.getCiudad().getId()).build()
						: null)
				.build();
