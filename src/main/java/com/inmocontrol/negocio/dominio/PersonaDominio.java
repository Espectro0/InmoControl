...
public final class PersonaDominio {
    private UUID id;
    ...
    private PersonaDominio(final Builder builder) {
        setId(builder.id);
    ...
    private void setTipoDocumento(final TipoDocumentoDominio tipoDocumento) {
    ...
    private void setCiudadResidencia(final CiudadDominio ciudadResidencia) {
    ...
    public static class Builder {
        ...
        public Builder tipoDocumento(final TipoDocumentoDominio tipoDocumento) {
            this.tipoDocumento = tipoDocumento;
            return this;
        }
        ...
        public Builder ciudadResidencia(final CiudadDominio ciudadResidencia) {
            this.ciudadResidencia = ciudadResidencia;
            return this;
        }
