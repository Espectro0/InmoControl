...
public class ModificarParametroClausulaContratoFachadaImpl
    implements ModificarParametroClausulaContratoFachada {
  ...
  public void ejecutar(ParametroClausulaContratoDTO datos) {
    ...
    try {
      ...
      throw new InmocontrolExcepcion(
          "Ocurrio un error modificando el parametro clausula contrato", excepcion);
