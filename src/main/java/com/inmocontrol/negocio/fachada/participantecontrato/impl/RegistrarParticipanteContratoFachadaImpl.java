...
public class RegistrarParticipanteContratoFachadaImpl
    implements RegistrarParticipanteContratoFachada {
  ...
  public void ejecutar(ParticipanteContratoDTO datos) {
    ...
    try {
      ...
      throw new InmocontrolExcepcion(
          "Ocurrio un error registrando el participante contrato", excepcion);
