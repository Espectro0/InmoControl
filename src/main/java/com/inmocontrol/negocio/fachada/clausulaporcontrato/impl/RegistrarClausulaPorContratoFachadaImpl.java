...
public class RegistrarClausulaPorContratoFachadaImpl
    implements RegistrarClausulaPorContratoFachada {
  ...
  public void ejecutar(ClausulaPorContratoDTO datos) {
    ...
    try {
      ...
      throw new InmocontrolExcepcion(
          "Ocurrio un error registrando la clausula por contrato", excepcion);
